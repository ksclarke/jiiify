...
public class BrowseHandler extends JiiifyHandler {
    ...
    public BrowseHandler(final Configuration aConfig) {
        super(aConfig);
    }
    ...
    public void handle(final RoutingContext aContext) {
        ...
        query.put("query", "*:*").put("limit", count).put("offset", start).put("filter", TYPE_FIELD + ":" + type);
